...
public class ConsoleCanvas extends JPanel implements ActionListener, KeyListener {
	...
	private PicoEngine.hsa2.GraphicsConsole container;
	...
	public ConsoleCanvas(int width, int height, int fontSize, String title, PicoEngine.hsa2.GraphicsConsole console)
	{
